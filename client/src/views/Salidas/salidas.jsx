...
import Eventos from "./Fotos/Eventos1.jpg";
    ...
    <div className={style.container}>
      ...
      <div className={style.fotos}>
        <div className={style.fotoContainer}>
          ...
          <img src={Desfile} alt="desfiles" className={style.foto} />
        </div>
        <div className={style.fotoContainer}>
          <h2 className={style.h2}>Sábados</h2>
          <img src={Sabado} alt="Sabados" className={style.foto} />
        </div>
        <div
          onClick={() =>
            handleRedirect(
        ...
        >
          ...
          <img src={Campa} alt="Campa" className={style.foto} />
        </div>
        <div className={style.fotoContainer}>
          <h2 className={style.h2}>Eventos</h2>
          <img src={Eventos} alt="Eventos" className={style.foto} />
        </div>
        <div className={style.fotoContainer}>
          <h2 className={style.h2}>Salidas</h2>
          <img src={Paint} alt="Salidas" className={style.foto} />
        </div>
        <div className={style.fotoContainer}>
          <h2 className={style.h2}>Banda</h2>
          <img src={Banda} alt="Banda" className={style.foto} />
        </div>
      </div>
      <Footer />
      {/* <div
